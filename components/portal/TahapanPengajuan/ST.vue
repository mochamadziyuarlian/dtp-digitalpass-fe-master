<template>
    <div>
        ...
        <div class="form-group">
            <h6 class="text-body-1 pt-1">
                Pilihan Jenis Pengujian Software Testing
                <em class="far fa-question-circle font-size-12 cursor-pointer" id="jenis_pengujian"></em>
            </h6>

            <b-popover target="jenis_pengujian" triggers="click hover" placement="right">
                <div>
                    <span class="font-weight-bold">Stress Test</span>
                    <p>Stress Test adalah ..</p>
                </div>
                <div>
                    <span class="font-weight-bold">Functional Test</span>
                    <p>Functional Test adalah ..</p>
                </div>
                <div>
                    <span class="font-weight-bold">Load Test</span>
                    <p>Load Test adalah ..</p>
                </div>
            </b-popover>

            <div class="pt-2">
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" id="checkbox1" value="Stress Test"
                        v-model.trim="Data.product_sub_test_type">
                    <label class="text-body-1 form-check-label" for="checkbox1">
                        Stress Test
                    </label>
                </div>
                <div class="form-check form-check-inline mx-4">
                    <input class="form-check-input" type="checkbox" id="checkbox2" value="Functional Test"
                        v-model.trim="Data.product_sub_test_type">
                    <label class="text-body-1 form-check-label" for="checkbox2">
                        Functional Test
                    </label>
                </div>
                <div class="form-check form-check-inline mx-4">
                    <input class="form-check-input" type="checkbox" id="checkbox3" value="Load Test"
                        v-model.trim="Data.product_sub_test_type">
                    <label class="text-body-1 form-check-label" for="checkbox3">
                        Load Test
                    </label>
                </div>
            </div>
