        ...
        <div class="mb-4">
            <form>
                ...
                <div class="form-group form-dsa">
                    ...
                    <treeselect class="treeselect" v-model="Form.permission" :multiple="true" :options="allPermission" :flat="true" />
                </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            SetValue(id) {
                this.Request('GET', '/api/v3/role/' + id.id, null, null, 'BEARER', (callback) => {
                    if (callback.code === 200) {
                        for (let x of callback.content) {
                            this.Form.role = x.name;
                            this.Form.permission = x.permission;
                        }
                    } else {
            ...
            UpdatePagePeran() {
                this.HelperConfirm(this.module, 'update').then((result) => {
                    if (result.isConfirmed) {
                        ...
                        this.Request('PUT', '/api/v3/role/update', null, body, 'BEARER', (callback) => {
                            if (callback.code === 200) {
